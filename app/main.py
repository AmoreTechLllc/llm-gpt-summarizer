"""
Mastodon Summarizer with ChatGPT

This script will take a Mastodon URL and use OpenAI's GPT models to generate
a summary of the Mastodon thread. It uses Streamlit for the UI and provides
...
def main(config: ConfigVars) -> None:
    ...
    st.set_page_config(page_title= "Mastodon Summarizer", page_icon="🐘", layout="wide")
